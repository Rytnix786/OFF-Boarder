    ...
    >
      <Box sx={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", mb: 2 }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
          <Typography sx={{ fontSize: "0.875rem", fontWeight: 700, color: isDark ? "#a1a1aa" : "#52525b" }}>
            {ticket.ticketNumber}
          </Typography>
          <Chip
      ...
      <Typography sx={{ fontSize: "1rem", fontWeight: 600, color: isDark ? "#fff" : "#0f172a", mb: 1, lineHeight: 1.4 }}>
        {ticket.subject}
      </Typography>
      ...
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 1 }}>
        ...
        <Typography sx={{ fontSize: "0.75rem", color: isDark ? "#71717a" : "#9ca3af" }}>
...
function TicketDetailDialog({
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth PaperProps={{ sx: { borderRadius: 2 } }}>
      ...
      <DialogContent>
        <Box sx={{ mt: 2 }}>
          <Typography sx={{ fontSize: "1.125rem", fontWeight: 600, color: isDark ? "#fff" : "#0f172a", mb: 2 }}>
            {ticket.subject}
          </Typography>
          ...
          >
            <Typography sx={{ fontSize: "0.875rem", color: isDark ? "#d4d4d8" : "#374151", whiteSpace: "pre-wrap", lineHeight: 1.6 }}>
              {ticket.message}
            </Typography>
          </Box>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 2, mb: 3 }}>
            <Box>
              <Typography sx={{ fontSize: "0.75rem", fontWeight: 600, color: isDark ? "#71717a" : "#6b7280", mb: 0.5 }}>
                Category
              </Typography>
              <Typography sx={{ fontSize: "0.875rem", color: isDark ? "#fff" : "#0f172a" }}>
          ...
          {ticket.context && (
            <Box sx={{ mb: 3 }}>
              <Typography sx={{ fontSize: "0.75rem", fontWeight: 600, color: isDark ? "#71717a" : "#6b7280", mb: 1 }}>
                Additional Context
              </Typography>
              <Box
                sx={{
          ...
          <Box sx={{ borderTop: "1px solid", borderColor: isDark ? "#27272a" : "#e5e7eb", pt: 3 }}>
            <Typography sx={{ fontSize: "0.875rem", fontWeight: 700, color: isDark ? "#fff" : "#0f172a", mb: 2 }}>
              Update Ticket
            </Typography>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 2, mb: 4 }}>
          {[
            ...
            >
              ...
              <Typography sx={{ fontSize: "0.75rem", color: isDark ? "#71717a" : "#6b7280", fontWeight: 500 }}>
                {stat.label}
              </Typography>
            </Box>
          ))}
      ...
      >
        ...
        {loading ? (
          ...
          <Box sx={{ py: 8, textAlign: "center" }}>
            <span className="material-symbols-outlined" style={{ fontSize: 48, color: isDark ? "#3f3f46" : "#d4d4d8", marginBottom: 12, display: "block" }}>
              confirmation_number
            </span>
