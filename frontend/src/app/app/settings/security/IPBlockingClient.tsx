...
interface IPBlockingClientProps {
  blockedIPs: BlockedIP[];
  organizationId: string;
}

export default function IPBlockingClient({ blockedIPs, organizationId }: IPBlockingClientProps) {
  ...
  return (
    <Box>
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 4 }}>
        <Box>
          <Typography variant="h4" fontWeight={800}>IP Blocking</Typography>
          <Typography color="text.secondary">
            Block IP addresses from accessing your organization
          </Typography>
        </Box>
        <Button
          variant="contained"
      ...
      <Alert severity="info" sx={{ mb: 3 }}>
        Blocked IPs will be denied access to login, registration, and all protected routes for your organization.
      </Alert>
                ...
                <TableRow>
                  <TableCell colSpan={8} sx={{ py: 8, textAlign: "center" }}>
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 1 }}>
                      <span className="material-symbols-outlined" style={{ fontSize: 48, color: "#9ca3af" }}>shield</span>
                      <Typography color="text.secondary">No blocked IP addresses</Typography>
                      <Typography variant="caption" color="text.secondary">
                        Block an IP address to prevent access from that location
                      </Typography>
                    </Box>
                  </TableCell>
                </TableRow>
            ...
            <Grid container spacing={2} sx={{ mt: 1 }}>
              ...
              <Grid size={{ xs: 12 }}>
                <TextField
                  ...
                  placeholder="Suspicious activity, former employee, etc."
                  multiline
                  rows={2}
                />
              </Grid>
      ...
      <Dialog open={confirmDialog?.open || false} onClose={() => setConfirmDialog(null)}>
        ...
        <DialogContent>
          <Alert severity="warning" sx={{ mt: 1 }}>
            ...
            This will immediately lock you out of the application.
          </Alert>
        </DialogContent>
        <DialogActions sx={{ p: 2 }}>
