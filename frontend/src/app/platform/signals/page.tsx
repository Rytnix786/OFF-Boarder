      ...
      <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
        ...
        >
          <span
            ...
            style={{ fontSize: 20, color: severityColor }}
          >
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 0.5 }}>
            ...
            {!isResolved && signal.acknowledged && (
              <Chip
                label="ACK"
                size="small"
                sx={{
          ...
          <Box sx={{ display: "flex", gap: 1, flexShrink: 0 }}>
            ...
            <Button
              ...
              sx={{
                fontSize: t.typography.fontSize.xs,
                textTransform: "none",
                bgcolor: incidentMode ? "#dc2626" : "#22c55e",
                "&:hover": {
                  bgcolor: incidentMode ? "#b91c1c" : "#16a34a",
                },
              }}
            >
              Resolve
...
export default function PlatformSignalsPage() {
  const theme = useTheme();
  const isDark = theme.palette.mode === "dark";
  ...
  const handleAcknowledge = async (id: string) => {
    try {
      await fetch("/api/platform/signals", {
        method: "PUT",
  ...
  const handleResolve = async () => {
    ...
    try {
      await fetch("/api/platform/signals", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ id: resolveDialog.id, resolve: true, resolution }),
      });
  ...
  return (
    <Box>
        ...
        {[
          ...
          <Box
            ...
            sx={{
              ...
              border: "1px solid",
              borderColor:
                stat.value > 0 && stat.label === "Critical"
                  ? alpha("#dc2626", 0.3)
                  : incidentMode
                  ? alpha("#dc2626", 0.2)
                  : isDark
          ...
          >
            ...
            <Typography
              sx={{
                ...
                fontWeight: 700,
                color: stat.value > 0 ? stat.color : isDark ? "#3f3f46" : "#d1d5db",
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <FormControl size="small" sx={{ minWidth: 180 }}>
            ...
            >
              ...
              <MenuItem value="APPROVAL_BYPASS_ATTEMPT">Approval Bypass</MenuItem>
              <MenuItem value="HIGH_RISK_OFFBOARDING">High Risk Offboarding</MenuItem>
              <MenuItem value="ORG_COMPLIANCE_ISSUE">Compliance Issue</MenuItem>
              <MenuItem value="POLICY_VIOLATION">Policy Violation</MenuItem>
              <MenuItem value="SYSTEM_ANOMALY">System Anomaly</MenuItem>
            </Select>
          </FormControl>
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
          {signals.map((signal) => (
            <SignalCard
              ...
              onResolve={(id) => setResolveDialog({ open: true, id })}
            />
          ))}
        </Box>
      )}
      ...
      {pagination.totalPages > 1 && (
        <Box sx={{ display: "flex", justifyContent: "center", mt: 4 }}>
          <Pagination
            ...
            onChange={(_, page) => fetchSignals(page)}
            sx={{
      ...
      <Dialog
        ...
        onClose={() => setResolveDialog({ open: false, id: null })}
        PaperProps={{
          sx: {
