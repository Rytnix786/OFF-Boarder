  ...
  return (
    ...
    >
      <Box sx={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", mb: 2 }}>
        ...
        {attention && (
          <Box sx={{ width: 10, height: 10, borderRadius: "50%", bgcolor: "#dc2626", animation: "pulse 1.5s infinite" }} />
        )}
      </Box>
      <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600, color: isDark ? "#a1a1aa" : "#52525b", textTransform: "uppercase", letterSpacing: "0.04em", mb: 0.75, lineHeight: 1.3 }}>
        {title}
      </Typography>
      <Typography sx={{ fontSize: "2rem", fontWeight: 700, color: isDark ? "#fff" : "#0f172a", lineHeight: 1.2, letterSpacing: "-0.02em" }}>
        {value}
      </Typography>
      {subtitle && (
        <Typography sx={{ fontSize: "0.875rem", color: isDark ? "#71717a" : "#9ca3af", mt: 0.75, lineHeight: 1.4 }}>
          {subtitle}
        </Typography>
      )}
    </Box>
  ...
  return (
    ...
    >
      ...
      <Box sx={{ flex: 1, minWidth: 0 }}>
        <Typography sx={{ fontSize: "0.9375rem", fontWeight: 600, color: isDark ? "#fff" : "#0f172a", lineHeight: 1.4 }}>
          {signal.title}
        </Typography>
        {signal.description && (
          <Typography
      ...
      >
        <Typography sx={{ fontSize: "0.75rem", fontWeight: 700, color, textTransform: "uppercase", letterSpacing: "0.02em" }}>
          {signal.severity}
        </Typography>
      </Box>
      <Typography sx={{ fontSize: "0.8125rem", fontWeight: 500, color: isDark ? "#71717a" : "#9ca3af", flexShrink: 0 }}>
...
export default function PlatformOverviewPage() {
  ...
  const hasAttention = (data?.signals.critical || 0) > 0 || (data?.offboardings.critical || 0) > 0;

    return (
      <Box>
        <Box sx={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", mb: 5 }}>
          <Box>
            <Typography sx={{ fontSize: "1.75rem", fontWeight: 700, color: isDark ? "#fff" : "#0f172a", letterSpacing: "-0.02em", mb: 1, lineHeight: 1.2 }}>
              Platform Overview
            </Typography>
            <Typography sx={{ fontSize: "1rem", color: isDark ? "#a1a1aa" : "#64748b", lineHeight: 1.5 }}>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)", lg: "repeat(4, 1fr)" }, gap: 2.5, mb: 5 }}>
        <MetricCard
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", lg: "1fr 1fr" }, gap: 3 }}>
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 3 }}>
              <Typography sx={{ fontSize: "1.125rem", fontWeight: 700, color: isDark ? "#fff" : "#0f172a", letterSpacing: "-0.01em" }}>
                Live Platform Signals
              </Typography>
              <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                <Typography sx={{ fontSize: "0.875rem", fontWeight: 500, color: isDark ? "#a1a1aa" : "#64748b" }}>
                  {data?.signals.unresolved || 0} unresolved
                </Typography>
                {(data?.signals.critical || 0) > 0 && (
                  <Box sx={{ px: 2, py: 0.5, borderRadius: 1, bgcolor: alpha("#dc2626", 0.1), border: `1px solid ${alpha("#dc2626", 0.2)}` }}>
        ...
        >
          <Typography sx={{ fontSize: "1.125rem", fontWeight: 700, color: isDark ? "#fff" : "#0f172a", mb: 3.5, letterSpacing: "-0.01em" }}>
            Systemic Risk Summary
          </Typography>
          <Box sx={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 2.5 }}>
            <Box sx={{ p: 3, borderRadius: 1.5, bgcolor: incidentMode ? alpha("#1c1917", 0.8) : isDark ? "#09090b" : "#fafafa" }}>
              <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600, color: isDark ? "#a1a1aa" : "#64748b", mb: 1.5, lineHeight: 1.3 }}>
                Organizations Suspended
              </Typography>
              <Typography sx={{ fontSize: "1.5rem", fontWeight: 700, color: "#f59e0b", letterSpacing: "-0.02em" }}>
            ...
            <Box sx={{ p: 3, borderRadius: 1.5, bgcolor: incidentMode ? alpha("#1c1917", 0.8) : isDark ? "#09090b" : "#fafafa" }}>
              ...
              <Typography sx={{ fontSize: "1.5rem", fontWeight: 700, color: (data?.security.unresolvedEvents || 0) > 0 ? "#dc2626" : "#22c55e", letterSpacing: "-0.02em" }}>
            ...
            <Box sx={{ p: 3, borderRadius: 1.5, bgcolor: incidentMode ? alpha("#1c1917", 0.8) : isDark ? "#09090b" : "#fafafa" }}>
              ...
              <Typography sx={{ fontSize: "1.5rem", fontWeight: 700, color: (data?.offboardings.highRisk || 0) > 0 ? "#f97316" : "#22c55e", letterSpacing: "-0.02em" }}>
            ...
            <Box sx={{ p: 3, borderRadius: 1.5, bgcolor: incidentMode ? alpha("#1c1917", 0.8) : isDark ? "#09090b" : "#fafafa" }}>
              ...
              <Typography sx={{ fontSize: "1.5rem", fontWeight: 700, color: (data?.offboardings.critical || 0) > 0 ? "#dc2626" : "#22c55e", letterSpacing: "-0.02em" }}>
